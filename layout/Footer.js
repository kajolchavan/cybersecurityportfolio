            ...
            <div className="col-lg-3 col-md-3">
              <div className="footer-widget widget_contact_info wow fadeInUp delay-0-6s">
                ...
                <ul>
                  ...
                  <li>
                    <i className="far fa-envelope" />{" "}
                    <a href="mailto:harshad.blog69@gmail.com">harshad.blog69@gmail.com</a>
                  </li>
                  <li>
          ...
          <div className="row">
            ...
            <div className="col-lg-6 text-lg-end">
              <ul className="footer-bottom-nav">
                ...
                <li>
                  <a href="https://www.instagram.com/i_harshadpawar/">Instagram</a>
                </li>
                <li>
                  <a href="https://www.linkedin.com/in/harshad-pawar-59009b211/">LinkedIn</a>
                </li>
              </ul>
            </div>
          </div>
