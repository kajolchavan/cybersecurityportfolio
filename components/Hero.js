        ...
        <div className="row align-items-center">
          <div className="col-lg-4 col-sm-7">
            <div className="hero-content rmb-55 wow fadeInUp delay-0-2s">
              ...
              <h2>
                <b>Harshad Pawar</b> Penetration Tester
              </h2>
              <p>
              Penetration Tester and Cybersecurity Expert, Working towards making Tech World More Secure.
              </p>
      ...
      <div className="container rel z-3">
        <div className="hero-two-content">
          <span className="sub-title wow fadeInLeft delay-0-1s">
            <i className="flaticon-asterisk-1" /> Penetration Tester
          </span>
          <span className="title wow fadeInLeft delay-0-2s">
            Hello <small>i,m</small>
          </span>
          <span className="name wow fadeInRight delay-0-4s">Harshad Pawar</span>
